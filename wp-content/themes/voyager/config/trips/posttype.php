...
function thb_trip_post_type() {
	...
	$thb_trips_labels = array(
		'name'               => __('Trips', 'thb-portfolio'),
		'singular_name'      => __('Trip', 'thb-portfolio'),
		'add_new'            => __('Add new', 'thb-portfolio'),
		'add_new_item'       => __('Add new Trip', 'thb-portfolio'),
		'edit'               => __('Edit', 'thb-portfolio'),
		'edit_item'          => __('Edit Trip', 'thb-portfolio'),
		'new_item'           => __('New Trip', 'thb-portfolio'),
		'view'               => __('View Trip', 'thb-portfolio'),
		'view_item'          => __('View Trip', 'thb-portfolio'),
		'search_items'       => __('Search Trips', 'thb-portfolio'),
		'not_found'          => __('No Trips found', 'thb-portfolio'),
		'not_found_in_trash' => __('No Trips found in Trash', 'thb-portfolio'),
		'parent'             => __('Parent Trip', 'thb-portfolio')
	);
	...
	$thb_trip_categories_args = array(
		'hierarchical'   => true,
		'labels' => array(
			'name'              => __('Trip Categories', 'thb-portfolio' ),
			'singular_name'     => __('Trip Category', 'thb-portfolio' ),
			'search_items'      => __( 'Search Trip Categories', 'thb-portfolio' ),
			'all_items'         => __( 'All Trip Categories', 'thb-portfolio' ),
			'parent_item'       => __( 'Parent Trip Category', 'thb-portfolio' ),
			'parent_item_colon' => __( 'Parent Trip Category:', 'thb-portfolio' ),
			'edit_item'         => __( 'Edit Trip Category', 'thb-portfolio' ),
			'update_item'       => __( 'Update Trip Category', 'thb-portfolio' ),
			'add_new_item'      => __( 'Add New Trip Category', 'thb-portfolio' ),
			'new_item_name'     => __( 'New Trip Category Name', 'thb-portfolio' ),
			'menu_name'         => __( 'Trip Category', 'thb-portfolio' )
		),
		'rewrite'        => true,
		'query_var'      => true
	);
